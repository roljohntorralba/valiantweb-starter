<article class="prose prose-slate prose-img:shadow-lg prose-img:shadow-slate-500/30 prose-headings:font-serif dark:prose-invert lg:prose-lg prose-a:text-primary-600 prose-blockquote:leading-normal">
